...
# Rerooting functions
#
# is_rooted calculates if the tree's root has 2 or less childre
# this is used in the is_binary function to check if a tree is binary 
# or not. id dupLoss specific
def is_rooted(tree):
